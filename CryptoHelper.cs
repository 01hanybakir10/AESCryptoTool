...
public class CryptoHelper
{
    ...
    private string AESKey = "AAECAwQFBgcICQoLDA0ODw==";
    private string AESIV = "AAECAwQFBgcICQoL";
    ...
    public string AESdecrypt(string cipherText, string key, string iv)
    {
        ...
        string decrypted = DecryptStringFromBytes_Aes(cipherBytes, Encoding.UTF8.GetBytes(key), Encoding.UTF8.GetBytes(iv));
        return decrypted;
    }
